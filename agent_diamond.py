...
def judge_review(name: str, review: str) -> tuple[str, str, str]:
    ...
    prompt = (
        ...
        f"Review ({name}):\n{review}\n\n"
        "Severity rubric — BLOCK if the review describes ANY of the following, "
        "even conditionally or hedged with 'if untrusted input' / 'at scale' / "
        "'in some cases':\n"
        ...
        "'could be...') as evidence the issue is unproven or minor — a real defect "
